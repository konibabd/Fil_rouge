    ...
    <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
            ...
            <div
                ...
                <h6 class="m-0 font-weight-bold text-primary">Revenus vue d'ensemble</h6>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 text-center small">
                    <span class="mr-2">
                        <i class="fas fa-circle text-primary"></i> Poussins
                    </span>
                    <span class="mr-2">
                        <i class="fas fa-circle text-success"></i> Poules 3/4
                    </span>
                    <span class="mr-2">
                        <i class="fas fa-circle text-info"></i> Pondeuses
                    </span>
                </div>
            </div>
        </div>
